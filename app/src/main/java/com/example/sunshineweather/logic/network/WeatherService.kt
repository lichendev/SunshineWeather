...
interface WeatherService {
    ...
    @GET("{token}/{longitude},{latitude}/daily.json")
    fun getDailyWeather(@Path("token")token: String, @Path("longitude") longitude: Double,
                           @Path("latitude")latitude:Double): Call<DailyWeaResResult>
}